...
if ( $wpas_tickets->have_posts() ):
	...
	<div class="wpas wpas-ticket-list alignwide">
		...
		<div class="table-responsive">
			<table id="wpas_ticketlist" class="wpas-table wpas-table-hover table table-hover" data-filter="#wpas_filter" data-filter-text-only="true" data-page-navigation=".wpas_table_pagination" data-page-size=" <?php echo $tickets_per_page ?> ">
				<thead>
					<tr>
